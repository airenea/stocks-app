...
RSpec.describe "Spec for admin-trader interaction", type: :system do       
    before do
        ...
        regular = Regular.create(name: 'Siren', surname: 'Trader', email: 'sirentrader@mail.com', password: '123456', password_confirmation: '123456', approved: true, confirmed_at: Time.now)
